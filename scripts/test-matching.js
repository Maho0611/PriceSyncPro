...
// 带 4 位日期戳的官方模型名必须匹配自身（日期戳剥离只在变体层兜底，不能破坏前层精确匹配）。
// 尤其"带戳版与基础版同时在表、价格不同"的模型（如 gpt-4o-2024-05-13 $5/M vs gpt-4o $2.5/M），
// 一旦清理层先于裸表精确匹配执行，就会错配到基础版价格造成真实计费错误（v3.6.2 修复）
const dateStubModelsMustMatchThemselves = [
  'grok-4-0709',
  'gpt-4-1106-preview',
  'gpt-4o-2024-05-13',                 // 带戳 $5/M vs 基础版 $2.5/M
  'mistral-large-2402',                // 带戳 $8/M vs 基础版 $2/M
  'o1-preview-2024-09-12',             // 带戳 $16.5/M vs 基础版 $15/M
  'cohere.command-a-reasoning-08-2025', // 点号前缀 + 日期戳，曾完全无法命中自身
  'ft:gpt-4.1-2025-04-14',             // ft: 前缀 + 日期戳，曾完全无法命中自身
];
